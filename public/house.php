        ...
        <main>
            <div class="forum">
                <div class="forum__info">
                    ...
                    <?
                    $topicForum = new TopicForum('house','msgHouse','comments_house');
                    $topicForum->topicForum();
                    ?>
                </div>
                <div class="pb">
                    <?
                    $pagTheme = new PaginationTheme('house','house');
                    $pagTheme->pagTheme();
        
                    $button = new ButtonAddTheme('addThemeHouse');
