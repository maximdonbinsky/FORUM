...
if (empty($_GET['page'])) {
    header("Location: work.php?page=1");
}
        ...
        <main>
            <div class="forum">
                <div class="forum__info">
                    ...
                    <?
                    $topicForum = new TopicForum('work','msgWork','comments_work');
                    $topicForum->topicForum();
                    ?>
                </div>
                <div class="pb">
                    <?
                    $pagTheme = new PaginationTheme('work','work');
                    $pagTheme->pagTheme();
        
                    $button = new ButtonAddTheme('addThemeWork');
