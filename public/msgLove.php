...
$addComment = new AddComment('comments_love', 'msgLove');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('love','msgLove');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_love','love','quoting_love');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_love','msgLove');
    ...
    <script>
        const eventClick = new EventPageMsg('love');
