...
$addComment = new AddComment('comments_pregnancy', 'msgPregnancy');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('pregnancy','msgPregnancy');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_pregnancy','pregnancy','quoting_pregnancy');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_pregnancy','msgPregnancy');
    ...
    <script>
        const eventClick = new EventPageMsg('pregnancy');
