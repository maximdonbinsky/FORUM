...
$addComment = new AddComment('comments_wedding', 'msgWedding');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('wedding','msgWedding');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_wedding','wedding','quoting_wedding');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_wedding','msgWedding');
    ...
    <script>
        const eventClick = new EventPageMsg('wedding');
