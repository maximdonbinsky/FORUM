...
$addComment = new AddComment('comments_workshop', 'msgWorkshop');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('workshop','msgWorkshop');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_workshop','workshop','quoting_workshop');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_workshop','msgWorkshop');
    ...
    <script>
        const eventClick = new EventPageMsg('workshop');
