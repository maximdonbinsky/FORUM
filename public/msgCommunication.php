...
$addComment = new AddComment('comments_communication', 'msgCommunication');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('communication','msgCommunication');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_communication','communication','quoting_communication');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_communication','msgCommunication');
    ...
    <script>
        const eventClick = new EventPageMsg('communication');
