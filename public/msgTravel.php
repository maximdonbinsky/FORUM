...
$addComment = new AddComment('comments_travel', 'msgTravel');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('travel','msgTravel');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_travel','travel','quoting_travel');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_travel','msgTravel');
    ...
    <script>
        const eventClick = new EventPageMsg('travel');
