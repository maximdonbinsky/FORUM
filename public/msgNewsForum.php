...
$addComment = new AddComment('comments_news_forum', 'msgNewsForum');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('news_forum','msgNewsForum');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_news_forum','news_forum','quoting_news_forum');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_news_forum','msgNewsForum');
    ...
    <script>
        const eventClick = new EventPageMsg('newsForum');
