...
if (empty($_GET['page'])) {
    header("Location: fashion.php?page=1");
}
        ...
        <main>
            <div class="forum">
                <div class="forum__info">
                    ...
                    <?
                    $topicForum = new TopicForum('fashion','msgFashion','comments_fashion');
                    $topicForum->topicForum();
                    ?>
                </div>
                <div class="pb">
                    <?
                    $pagTheme = new PaginationTheme('fashion','fashion');
                    $pagTheme->pagTheme();
        
                    $button = new ButtonAddTheme('addThemeFashion');
