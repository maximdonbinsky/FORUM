...
$addComment = new AddComment('comments_children', 'msgChildren');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('children','msgChildren');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_children','children','quoting_children');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_children','msgChildren');
    ...
    <script>
        const eventClick = new EventPageMsg('children');
