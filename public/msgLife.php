...
$addComment = new AddComment('comments_life', 'msgLife');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('life','msgLife');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_life','life','quoting_life');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_life','msgLife');
    ...
    <script>
        const eventClick = new EventPageMsg('life');
