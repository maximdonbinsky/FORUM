...
$addComment = new AddComment('comments_hobby', 'msgHobby');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('hobby','msgHobby');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_hobby','hobby','quoting_hobby');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_hobby','msgHobby');
    ...
    <script>
        const eventClick = new EventPageMsg('hobby');
