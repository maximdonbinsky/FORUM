...
if (empty($_GET['page'])) {
    header("Location: travel.php?page=1");
}
        ...
        <main>
            <div class="forum">
                <div class="forum__info">
                    ...
                    <?
                    $topicForum = new TopicForum('travel','msgTravel','comments_travel');
                    $topicForum->topicForum();
                    ?>
                </div>
                <div class="pb">
                    <?
                    $pagTheme = new PaginationTheme('travel','travel');
                    $pagTheme->pagTheme();
        
                    $button = new ButtonAddTheme('addThemeTravel');
