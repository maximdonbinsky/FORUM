...
if (empty($_GET['page'])) {
    header("Location: children.php?page=1");
}
...
<body>
        ...
        <main>
            <div class="forum">
                <div class="forum__info">
                    ...
                    <?
                    $topicForum = new TopicForum('children','msgChildren','comments_children');
                    $topicForum->topicForum();
                    ?>
                </div>
                <div class="pb">
                    <?
                    $pagTheme = new PaginationTheme('children','children');
                    $pagTheme->pagTheme();
        
                    $button = new ButtonAddTheme('addThemeChildren');
    ...
    <script>
        const views = new Views('children');
        views.addViews();
    </script>  
</body>
</html>