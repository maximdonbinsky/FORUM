...
$addComment = new AddComment('comments_health', 'msgHealth');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('health','msgHealth');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_health','health','quoting_health');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_health','msgHealth');
    ...
    <script>
        const eventClick = new EventPageMsg('health');
