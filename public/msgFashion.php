...
$addComment = new AddComment('comments_fashion', 'msgFashion');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('fashion','msgFashion');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_fashion','fashion','quoting_fashion');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_fashion','msgFashion');
    ...
    <script>
        const eventClick = new EventPageMsg('fashion');
