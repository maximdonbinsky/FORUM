...
$addComment = new AddComment('comments_hostess', 'msgHostess');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('hostess','msgHostess');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_hostess','hostess','quoting_hostess');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_hostess','msgHostess');
    ...
    <script>
        const eventClick = new EventPageMsg('hostess');
