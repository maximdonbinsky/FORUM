...
$addComment = new AddComment('comments_house', 'msgHouse');
...
<body>
    <div class="cont">
        ...
        <main>
            <div class="forum">
                ...
                <?
                    $showTopic = new ShowTopic('house','msgHouse');
                    $showTopic -> showTopic();

                    $showComment = new ShowComment('comments_house','house','quoting_house');
                    $showComment -> showComment();
                ?>
                </div>
                <?
                    $pagination = new Pagination('comments_house','msgHouse');
    ...
    <script>
        const eventClick = new EventPageMsg('house');
